...
`;class je extends ae{constructor(){super(...arguments),this.open=!1,this.title="",this.hideActions=!1,this.confirmText="Confirmer",this.cancelText="Annuler",this.hideCancel=!1,this.loading=!1}handleOverlayClick(e){e.target===e.currentTarget&&this.close()}handleCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0})),this.close()}handleConfirm(){this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}close(){this.open=!1}render(){return this.open?L`
          ...
          ${this.hideActions?"":L`
                <div class="dialog-actions">
                  ...
                  <button
                    ...
                    ?disabled="${this.loading}"
                  >
                    ${this.loading?L`<span class="loading-spinner"></span>`:""}${this.confirmText}
                  </button>
                </div>
              `}
        </div>
  ...
  `,e([de({type:Boolean,reflect:!0})],je.prototype,"open",void 0),e([de({type:String})],je.prototype,"title",void 0),e([de({type:Boolean})],je.prototype,"hideActions",void 0),e([de({type:String})],je.prototype,"confirmText",void 0),e([de({type:String})],je.prototype,"cancelText",void 0),e([de({type:Boolean})],je.prototype,"hideCancel",void 0),e([de({type:Boolean})],je.prototype,"loading",void 0),customElements.get("hm-dialog")||customElements.define("hm-dialog",je);class Le extends ae{constructor(){super(...arguments),this.icon="",this.iconColor="",this.clickable=!1,this.selected=!1}handleClick(){this.clickable&&this.dispatchEvent(new CustomEvent("item-click",{bubbles:!0,composed:!0}))}render(){return L`
      <div
  ...
  `,e([de({type:String})],Le.prototype,"icon",void 0),e([de({type:String})],Le.prototype,"iconColor",void 0),e([de({type:Boolean})],Le.prototype,"clickable",void 0),e([de({type:Boolean})],Le.prototype,"selected",void 0),customElements.get("hm-item-card")||customElements.define("hm-item-card",Le);class Fe extends ae{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.required=!1,this.disabled=!1,this.rows=3,this.error="",this.helper=""}handleInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return L`
      <div class="textarea-container">
        ${this.label?L`<label class="${this.required?"required":""}">${this.label}</label>`:""}
        <textarea
          .value="${this.value}"
        ...
        ></textarea>
        ${this.error?L`<span class="error-text">${this.error}</span>`:this.helper?L`<span class="helper-text">${this.helper}</span>`:""}
        ${this.maxlength?L`<span class="char-count">${this.value.length} / ${this.maxlength}</span>`:""}
      </div>
    `}}Fe.styles=a`
    :host {
      display: block;
  ...
  `,e([de({type:String})],Fe.prototype,"label",void 0),e([de({type:String})],Fe.prototype,"value",void 0),e([de({type:String})],Fe.prototype,"placeholder",void 0),e([de({type:Boolean})],Fe.prototype,"required",void 0),e([de({type:Boolean})],Fe.prototype,"disabled",void 0),e([de({type:Number})],Fe.prototype,"rows",void 0),e([de({type:Number})],Fe.prototype,"maxlength",void 0),e([de({type:String})],Fe.prototype,"error",void 0),e([de({type:String})],Fe.prototype,"helper",void 0),customElements.get("hm-form-textarea")||customElements.define("hm-form-textarea",Fe);class qe extends ae{constructor(){super(...arguments),this.label="",this.checked=!1,this.disabled=!1,this.helper=""}handleChange(e){const t=e.target;this.checked=t.checked,this.dispatchEvent(new CustomEvent("checked-changed",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}render(){return L`
      <div>
        ...
        ${this.helper?L`<div class="helper-text">${this.helper}</div>`:""}
      </div>
    `}}qe.styles=a`
    :host {
      display: block;
  ...
  `,e([de({type:String})],qe.prototype,"label",void 0),e([de({type:Boolean})],qe.prototype,"checked",void 0),e([de({type:Boolean})],qe.prototype,"disabled",void 0),e([de({type:String})],qe.prototype,"helper",void 0),customElements.get("hm-form-checkbox")||customElements.define("hm-form-checkbox",qe);let Be=class extends ae{constructor(){super(...arguments),this._children=[],this._showValidateDialog=!1,this._showRefuseDialog=!1,this._showApproveClaimDialog=!1,this._validationNote="",this._refuseNote="",this._applyPenalty=!1,this._loading=!1}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e,console.log("%c╔═══════════════════════════════════════════════════════╗","color: #ff9800; font-weight: bold"),console.log("%c║  👨‍👩‍👧‍👦 Habits Supervision Card                         ║","color: #ff9800; font-weight: bold"),console.log("%c║  Version: 2025-11-07T19:30:00Z                ║","color: #ff9800; font-weight: bold"),console.log(`%c║  API Version: ${Ne}         ║`,"color: #ff9800; font-weight: bold"),console.log("%c╚═══════════════════════════════════════════════════════╝","color: #ff9800; font-weight: bold")}getCardSize(){return 3}updated(e){var t;super.updated(e),e.has("hass")&&this.hass&&(this._store||(console.log("[Supervision Card] Initializing store with hass:",!!this.hass),this._store=(t=this.hass,new Me(t)),this._unsubscribe=this._store.subscribe(()=>{console.log("[Supervision Card] Store state changed, requesting update"),this._loadData(),this.requestUpdate()}),this._loadData(),this.requestUpdate()))}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._store&&this._store.destroy()}_loadData(){this._store&&(this._children=this._store.getChildren())}render(){if(!this._config||!this.hass)return L``;const e=this._config.title||"Supervision";if(!this._store)return L`
        <ha-card>
          <div class="card">
      ...
      `;const t=this._store.getState();return t.loading?L`
        <ha-card>
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">${e}</h1>
    ...
    `}_renderChildrenOverview(){return L`
      <div class="section">
    ...
    `}_renderChildCard(e){const t=this._store?.getTaskCounts(e.id)||{pending:0,waiting:0},s=this._store?.getHabitStats(e.id)||{longest_streak:0};return L`
      <hm-item-card
        .icon=${"👤"}
      ...
      >
        <div>
          ...
          <div style="margin-top: 8px; display: flex; gap: 8px; flex-wrap: wrap;">
            ${t.pending>0?L`<span class="badge badge-primary">${t.pending} à faire</span>`:""}
            ${t.waiting>0?L`<span class="badge badge-warning">${t.waiting} à valider</span>`:""}
            ${s.longest_streak>0?L`<span class="badge badge-success">🔥 ${s.longest_streak} jours</span>`:""}
          </div>
        </div>
      </hm-item-card>
    `}_renderTasksSection(){const e=[];return this._children.forEach(t=>{(this._store?.getTasksWaitingValidation(t.id)||[]).forEach(s=>{e.push({...s,child_id:t.id,child_name:t.name})})}),L`
      <div class="section">
        <h2 class="section-title">Tâches en attente de validation (${e.length})</h2>
        ...
        ${0===e.length?L`
            ...
            `:L`
              <div style="display: flex; flex-direction: column; gap: 12px;">
                ${e.map(e=>this._renderTaskValidationItem(e))}
              </div>
            `}
      </div>
    `}_renderTaskValidationItem(e){const t=e.completed_at?new Date(e.completed_at).toLocaleString("fr-FR"):"Date inconnue";return L`
      <hm-item-card .icon=${"✓"} .iconColor=${"var(--success-color)"}>
        <div style="flex: 1;">
          <h4 style="margin: 0; font-size: 15px;">${e.task_title}</h4>
          <p style="margin: 4px 0 0 0; font-size: 13px; color: var(--secondary-text-color);">
            Par: <strong>${e.child_name}</strong> • Complétée le ${t}
          </p>
          <p style="margin: 4px 0 0 0; font-size: 12px; color: var(--secondary-text-color);">
            Récompense: +${e.rewards.points} pts, +${e.rewards.coins} 💰, +${e.rewards.experience} XP
          </p>
        </div>
        <div slot="actions" style="display: flex; gap: 8px;">
          <button
            ...
            @click=${()=>this._handleValidateTask(e.instance_id,e.child_id)}
          >
            ✓ Valider
          </button>
          <button
            ...
            style="padding: 6px 12px; font-size: 13px;"
            @click=${()=>this._handleRefuseTask(e.instance_id,e.child_id)}
          >
            ✗ Refuser
          </button>
        </div>
      </hm-item-card>
    `}_renderTaskValidationExample(){return L`
    ...
    `}_renderClaimsSection(){const e=[];return this._children.forEach(t=>{(this._store?.getPendingClaims(t.id)||[]).forEach(s=>{e.push({...s,child_id:t.id,child_name:t.name})})}),L`
      <div class="section">
        <h2 class="section-title">Réclamations de récompenses (${e.length})</h2>
        ...
        ${0===e.length?L`
            ...
            `:L`
              <div style="display: flex; flex-direction: column; gap: 12px;">
                ${e.map(e=>this._renderClaimApprovalItem(e))}
              </div>
            `}
      </div>
    `}_renderClaimApprovalItem(e){const t=e.claimed_at?new Date(e.claimed_at).toLocaleString("fr-FR"):"Date inconnue";return L`
      <hm-item-card .icon=${"🎁"} .iconColor=${"var(--primary-color)"}>
        <div style="flex: 1;">
          <h4 style="margin: 0; font-size: 15px;">${e.reward_title}</h4>
          <p style="margin: 4px 0 0 0; font-size: 13px; color: var(--secondary-text-color);">
            Réclamée par: <strong>${e.child_name}</strong> • Le ${t}
          </p>
          <p style="margin: 4px 0 0 0; font-size: 12px; color: var(--secondary-text-color);">
            Coût: ${e.cost_points} pts, ${e.cost_coins} 💰
          </p>
        </div>
        <div slot="actions" style="display: flex; gap: 8px;">
          <button
            class="button button-success"
            style="padding: 6px 12px; font-size: 13px;"
            @click=${()=>this._handleApproveClaim(e.claim_id,e.child_id)}
          >
            ✓ Approuver
          </button>
        </div>
      </hm-item-card>
    `}_renderClaimApprovalExample(){return L`
      <div style="margin-top: 16px;">
        <p style="font-size: 13px; color: var(--secondary-text-color); margin-bottom: 8px;">
          <strong>Aperçu UI</strong> (Exemple de ce qui sera affiché une fois les données disponibles):
        </p>
    ...
    `}_renderValidateDialog(){return L`
      <hm-dialog
    ...
    `}_renderApproveClaimDialog(){return L`
      <hm-dialog
