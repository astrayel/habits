...
`;class Ut extends ot{constructor(){super(...arguments),this.open=!1,this.title="",this.hideActions=!1,this.confirmText="Confirmer",this.cancelText="Annuler",this.hideCancel=!1,this.loading=!1}handleOverlayClick(t){t.target===t.currentTarget&&this.close()}handleCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0})),this.close()}handleConfirm(){this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}close(){this.open=!1}render(){return this.open?V`
  ...
  `,t([dt({type:Boolean})],Ut.prototype,"open",void 0),t([dt({type:String})],Ut.prototype,"title",void 0),t([dt({type:Boolean})],Ut.prototype,"hideActions",void 0),t([dt({type:String})],Ut.prototype,"confirmText",void 0),t([dt({type:String})],Ut.prototype,"cancelText",void 0),t([dt({type:Boolean})],Ut.prototype,"hideCancel",void 0),t([dt({type:Boolean})],Ut.prototype,"loading",void 0),customElements.get("hm-dialog")||customElements.define("hm-dialog",Ut);class Nt extends ot{constructor(){super(...arguments),this.icon="",this.iconColor="",this.clickable=!1,this.selected=!1}handleClick(){this.clickable&&this.dispatchEvent(new CustomEvent("item-click",{bubbles:!0,composed:!0}))}render(){return V`
      <div
  ...
  `,t([dt({type:String})],Nt.prototype,"icon",void 0),t([dt({type:String})],Nt.prototype,"iconColor",void 0),t([dt({type:Boolean})],Nt.prototype,"clickable",void 0),t([dt({type:Boolean})],Nt.prototype,"selected",void 0),customElements.get("hm-item-card")||customElements.define("hm-item-card",Nt);class Ht extends ot{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.required=!1,this.disabled=!1,this.rows=3,this.error="",this.helper=""}handleInput(t){const e=t.target;this.value=e.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return V`
  ...
  `,t([dt({type:String})],Ht.prototype,"label",void 0),t([dt({type:String})],Ht.prototype,"value",void 0),t([dt({type:String})],Ht.prototype,"placeholder",void 0),t([dt({type:Boolean})],Ht.prototype,"required",void 0),t([dt({type:Boolean})],Ht.prototype,"disabled",void 0),t([dt({type:Number})],Ht.prototype,"rows",void 0),t([dt({type:Number})],Ht.prototype,"maxlength",void 0),t([dt({type:String})],Ht.prototype,"error",void 0),t([dt({type:String})],Ht.prototype,"helper",void 0),customElements.get("hm-form-textarea")||customElements.define("hm-form-textarea",Ht);class Ot extends ot{constructor(){super(...arguments),this.label="",this.checked=!1,this.disabled=!1,this.helper=""}handleChange(t){const e=t.target;this.checked=e.checked,this.dispatchEvent(new CustomEvent("checked-changed",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}render(){return V`
      <div>
  ...
  `,t([dt({type:String})],Ot.prototype,"label",void 0),t([dt({type:Boolean})],Ot.prototype,"checked",void 0),t([dt({type:Boolean})],Ot.prototype,"disabled",void 0),t([dt({type:String})],Ot.prototype,"helper",void 0),customElements.get("hm-form-checkbox")||customElements.define("hm-form-checkbox",Ot);let jt=class extends ot{constructor(){super(...arguments),this._children=[],this._showValidateDialog=!1,this._showRefuseDialog=!1,this._showApproveClaimDialog=!1,this._validationNote="",this._refuseNote="",this._applyPenalty=!1,this._loading=!1}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}getCardSize(){return 3}updated(t){var e;super.updated(t),t.has("hass")&&this.hass&&(this._store||(this._store=(e=this.hass,new Rt(e)),this._unsubscribe=this._store.subscribe(()=>{this._loadData(),this.requestUpdate()}),this._loadData()))}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._store&&this._store.destroy()}_loadData(){this._store&&(this._children=this._store.getChildren())}render(){if(!this._config||!this.hass)return V``;const t=this._config.title||"Supervision";return V`
      <ha-card>
        <div class="card">
