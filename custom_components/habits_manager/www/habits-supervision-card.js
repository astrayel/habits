...
`;class jt extends ot{constructor(){super(...arguments),this.open=!1,this.title="",this.hideActions=!1,this.confirmText="Confirmer",this.cancelText="Annuler",this.hideCancel=!1,this.loading=!1}handleOverlayClick(t){t.target===t.currentTarget&&this.close()}handleCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0})),this.close()}handleConfirm(){this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}close(){this.open=!1}render(){return this.open?V`
  ...
  `,t([dt({type:Boolean})],jt.prototype,"open",void 0),t([dt({type:String})],jt.prototype,"title",void 0),t([dt({type:Boolean})],jt.prototype,"hideActions",void 0),t([dt({type:String})],jt.prototype,"confirmText",void 0),t([dt({type:String})],jt.prototype,"cancelText",void 0),t([dt({type:Boolean})],jt.prototype,"hideCancel",void 0),t([dt({type:Boolean})],jt.prototype,"loading",void 0),customElements.get("hm-dialog")||customElements.define("hm-dialog",jt);class Mt extends ot{constructor(){super(...arguments),this.icon="",this.iconColor="",this.clickable=!1,this.selected=!1}handleClick(){this.clickable&&this.dispatchEvent(new CustomEvent("item-click",{bubbles:!0,composed:!0}))}render(){return V`
      <div
  ...
  `,t([dt({type:String})],Mt.prototype,"icon",void 0),t([dt({type:String})],Mt.prototype,"iconColor",void 0),t([dt({type:Boolean})],Mt.prototype,"clickable",void 0),t([dt({type:Boolean})],Mt.prototype,"selected",void 0),customElements.get("hm-item-card")||customElements.define("hm-item-card",Mt);class Lt extends ot{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.required=!1,this.disabled=!1,this.rows=3,this.error="",this.helper=""}handleInput(t){const e=t.target;this.value=e.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return V`
  ...
  `,t([dt({type:String})],Lt.prototype,"label",void 0),t([dt({type:String})],Lt.prototype,"value",void 0),t([dt({type:String})],Lt.prototype,"placeholder",void 0),t([dt({type:Boolean})],Lt.prototype,"required",void 0),t([dt({type:Boolean})],Lt.prototype,"disabled",void 0),t([dt({type:Number})],Lt.prototype,"rows",void 0),t([dt({type:Number})],Lt.prototype,"maxlength",void 0),t([dt({type:String})],Lt.prototype,"error",void 0),t([dt({type:String})],Lt.prototype,"helper",void 0),customElements.get("hm-form-textarea")||customElements.define("hm-form-textarea",Lt);class Vt extends ot{constructor(){super(...arguments),this.label="",this.checked=!1,this.disabled=!1,this.helper=""}handleChange(t){const e=t.target;this.checked=e.checked,this.dispatchEvent(new CustomEvent("checked-changed",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}render(){return V`
      <div>
  ...
  `,t([dt({type:String})],Vt.prototype,"label",void 0),t([dt({type:Boolean})],Vt.prototype,"checked",void 0),t([dt({type:Boolean})],Vt.prototype,"disabled",void 0),t([dt({type:String})],Vt.prototype,"helper",void 0),customElements.get("hm-form-checkbox")||customElements.define("hm-form-checkbox",Vt);let qt=class extends ot{constructor(){super(...arguments),this._children=[],this._showValidateDialog=!1,this._showRefuseDialog=!1,this._showApproveClaimDialog=!1,this._validationNote="",this._refuseNote="",this._applyPenalty=!1,this._loading=!1}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}getCardSize(){return 3}updated(t){var e;super.updated(t),t.has("hass")&&this.hass&&(this._store||(this._store=(e=this.hass,new Nt(e)),this._unsubscribe=this._store.subscribe(()=>{this._loadData(),this.requestUpdate()}),this._loadData()))}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._store&&this._store.destroy()}_loadData(){this._store&&(this._children=this._store.getChildren())}render(){if(!this._config||!this.hass)return V``;const t=this._config.title||"Supervision";return V`
      <ha-card>
        <div class="card">
