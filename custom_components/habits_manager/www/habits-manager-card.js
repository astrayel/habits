...
`;var Le,je,Fe,Be,We,Ye,Ve,Ge,Ke,Xe,Ze;!function(e){e.MANDATORY="mandatory",e.BONUS="bonus"}(Le||(Le={})),function(e){e.DAILY="daily",e.WEEKLY="weekly",e.MONTHLY="monthly",e.SPECIFIC_DATE="specific_date"}(je||(je={})),function(e){e.CHORES="chores",e.HOMEWORK="homework",e.PERSONAL="personal",e.OTHER="other"}(Fe||(Fe={})),function(e){e.PENDING="pending",e.COMPLETED_WAITING="completed_waiting",e.VALIDATED="validated",e.REFUSED="refused",e.FAILED="failed"}(Be||(Be={})),function(e){e.DAILY="daily",e.WEEKLY="weekly",e.MONTHLY="monthly"}(We||(We={})),function(e){e.PROGRESSIVE="progressive",e.FIXED="fixed"}(Ye||(Ye={})),function(e){e.SCREEN_TIME="screen_time",e.MEAL_CHOICE="meal_choice",e.ACTIVITY="activity",e.OTHER="other"}(Ve||(Ve={})),function(e){e.PENDING="pending",e.APPROVED="approved",e.USED="used",e.EXPIRED="expired"}(Ge||(Ge={})),function(e){e.CLOTHES="clothes",e.ACCESSORY="accessory",e.PET="pet",e.THEME="theme",e.BADGE="badge",e.ANIMATION="animation"}(Ke||(Ke={})),function(e){e.COMMON="common",e.RARE="rare",e.EPIC="epic",e.LEGENDARY="legendary"}(Xe||(Xe={})),function(e){e.FIRST_TASK="first_task",e.TASKS_COUNT="tasks_count",e.STREAK_DAYS="streak_days",e.LEVEL_REACHED="level_reached",e.POINTS_EARNED="points_earned"}(Ze||(Ze={}));class Je extends oe{constructor(){super(...arguments),this.label="",this.value="",this.type="text",this.placeholder="",this.required=!1,this.disabled=!1,this.error="",this.helper=""}handleInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){return j`
  ...
  `,e([de({type:String})],rt.prototype,"icon",void 0),e([de({type:String})],rt.prototype,"iconColor",void 0),e([de({type:Boolean})],rt.prototype,"clickable",void 0),e([de({type:Boolean})],rt.prototype,"selected",void 0),customElements.get("hm-item-card")||customElements.define("hm-item-card",rt);const st="2025-11-07T19:30:00Z";let at=class extends oe{constructor(){super(...arguments),this._activeTab="children",this._showDialog=!1,this._dialogMode="create",this._loading=!1,this._error="",this._formData={}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e,console.log("%c╔═══════════════════════════════════════════════════════╗","color: #03a9f4; font-weight: bold"),console.log("%c║  🏠 Habits Manager Card (Manager)                    ║","color: #03a9f4; font-weight: bold"),console.log(`%c║  Version: ${st}                ║`,"color: #03a9f4; font-weight: bold"),console.log(`%c║  API Version: ${Ne}         ║`,"color: #03a9f4; font-weight: bold"),console.log("%c╚═══════════════════════════════════════════════════════╝","color: #03a9f4; font-weight: bold")}getCardSize(){return 3}updated(e){var t;super.updated(e),e.has("hass")&&this.hass&&!this._store&&(console.log("[Manager Card] Initializing store with hass:",!!this.hass),this._store=(t=this.hass,new ze(t)),this._store.subscribe(()=>{console.log("[Manager Card] Store state changed, requesting update"),this.requestUpdate()}),this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),this._store&&this._store.destroy()}render(){if(!this._config||!this.hass)return j`<div>Loading Habits Manager v${st}...</div>`;const e=this._config.title||"Gestionnaire de Tâches";return j`
    ...
    `}_handleTabChange(e){this._activeTab=e,this._error=""}_renderContent(){switch(this._activeTab){case"children":return this._renderChildrenSection();case"tasks":return this._renderTasksSection();case"habits":return this._renderHabitsSection();case"rewards":return this._renderRewardsSection();case"cosmetics":return this._renderCosmeticsSection();default:return j``}}_renderChildrenSection(){if(!this._store)return console.log("[Manager Card] No store available yet"),j`<div class="loading">Initialisation du store...</div>`;const e=this._store.getState();if(console.log("[Manager Card] Rendering children section, loading:",e.loading,"children count:",e.children.length),e.loading)return j`<div class="loading">Chargement des données...</div>`;if(e.error)return j`
        <div class="section">
          <div class="error-banner">
