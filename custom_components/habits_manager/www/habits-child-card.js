...
`;var Ht,Mt,Ut,Nt,Dt,Lt,jt,Bt,qt,Ft,Vt;!function(t){t.MANDATORY="mandatory",t.BONUS="bonus"}(Ht||(Ht={})),function(t){t.DAILY="daily",t.WEEKLY="weekly",t.MONTHLY="monthly",t.SPECIFIC_DATE="specific_date"}(Mt||(Mt={})),function(t){t.CHORES="chores",t.HOMEWORK="homework",t.PERSONAL="personal",t.OTHER="other"}(Ut||(Ut={})),function(t){t.PENDING="pending",t.COMPLETED_WAITING="completed_waiting",t.VALIDATED="validated",t.REFUSED="refused",t.FAILED="failed"}(Nt||(Nt={})),function(t){t.DAILY="daily",t.WEEKLY="weekly",t.MONTHLY="monthly"}(Dt||(Dt={})),function(t){t.PROGRESSIVE="progressive",t.FIXED="fixed"}(Lt||(Lt={})),function(t){t.SCREEN_TIME="screen_time",t.MEAL_CHOICE="meal_choice",t.ACTIVITY="activity",t.OTHER="other"}(jt||(jt={})),function(t){t.PENDING="pending",t.APPROVED="approved",t.USED="used",t.EXPIRED="expired"}(Bt||(Bt={})),function(t){t.CLOTHES="clothes",t.ACCESSORY="accessory",t.PET="pet",t.THEME="theme",t.BADGE="badge",t.ANIMATION="animation"}(qt||(qt={})),function(t){t.COMMON="common",t.RARE="rare",t.EPIC="epic",t.LEGENDARY="legendary"}(Ft||(Ft={})),function(t){t.FIRST_TASK="first_task",t.TASKS_COUNT="tasks_count",t.STREAK_DAYS="streak_days",t.LEVEL_REACHED="level_reached",t.POINTS_EARNED="points_earned"}(Vt||(Vt={}));const Yt={[Ft.COMMON]:"#9E9E9E",[Ft.RARE]:"#2196F3",[Ft.EPIC]:"#9C27B0",[Ft.LEGENDARY]:"#FF9800"};Ht.MANDATORY,Ht.BONUS;class Wt extends ot{constructor(){super(...arguments),this.icon="",this.iconColor="",this.clickable=!1,this.selected=!1}handleClick(){this.clickable&&this.dispatchEvent(new CustomEvent("item-click",{bubbles:!0,composed:!0}))}render(){return B`
      <div
  ...
  `,t([lt({type:String})],Wt.prototype,"icon",void 0),t([lt({type:String})],Wt.prototype,"iconColor",void 0),t([lt({type:Boolean})],Wt.prototype,"clickable",void 0),t([lt({type:Boolean})],Wt.prototype,"selected",void 0),customElements.get("hm-item-card")||customElements.define("hm-item-card",Wt);class Gt extends ot{constructor(){super(...arguments),this.open=!1,this.title="",this.hideActions=!1,this.confirmText="Confirmer",this.cancelText="Annuler",this.hideCancel=!1,this.loading=!1}handleOverlayClick(t){t.target===t.currentTarget&&this.close()}handleCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0})),this.close()}handleConfirm(){this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}close(){this.open=!1}render(){return this.open?B`
        ...
        <div class="cosmetics-grid">
          ${t.map(t=>{const e=this.getItemStatus(t),i=this.getUnlockRequirementsText(t);return B`
              ...
              >
                <div
                  class="rarity-badge"
                  style="background-color: ${Yt[t.rarity]}"
                >
  ...
  `,t([lt({type:Object})],Jt.prototype,"child",void 0),t([lt({type:Array})],Jt.prototype,"availableCosmetics",void 0),t([lt({type:Array})],Jt.prototype,"allCosmetics",void 0),t([ht()],Jt.prototype,"selectedCategory",void 0),t([ht()],Jt.prototype,"selectedCosmetic",void 0),t([ht()],Jt.prototype,"showPurchaseDialog",void 0),customElements.get("hm-dialog")||customElements.define("hm-cosmetics-shop",Jt);class Kt extends ot{constructor(){super(),this.ownedCosmetics=[],this.selectedCategory=null,this.editingAvatar={photo_url:"",customization:{clothes:null,accessory:null,pet:null,theme:"default"}}}connectedCallback(){super.connectedCallback(),this.child&&(this.editingAvatar=JSON.parse(JSON.stringify(this.child.avatar)))}updated(t){t.has("child")&&this.child&&(this.editingAvatar=JSON.parse(JSON.stringify(this.child.avatar)))}getCategoryIcon(t){return{clothes:"👕",accessory:"🎩",pet:"🐕",theme:"🎨",badge:"🏆",animation:"✨"}[t]||""}getCategoryLabel(t){return{clothes:"Vêtements",accessory:"Accessoires",pet:"Animaux",theme:"Thèmes",badge:"Badges",animation:"Animations"}[t]||""}getCustomizableCategories(){return[qt.CLOTHES,qt.ACCESSORY,qt.PET,qt.THEME]}getCosmeticsForCategory(t){return this.ownedCosmetics.filter(e=>e.category===t)}getSelectedCosmeticId(t){const e=this.editingAvatar.customization;switch(t){case qt.CLOTHES:return e.clothes;case qt.ACCESSORY:return e.accessory;case qt.PET:return e.pet;case qt.THEME:return e.theme;default:return null}}selectCosmetic(t,e){const i={...this.editingAvatar.customization};switch(t){case qt.CLOTHES:i.clothes=e;break;case qt.ACCESSORY:i.accessory=e;break;case qt.PET:i.pet=e;break;case qt.THEME:i.theme=e}this.editingAvatar={...this.editingAvatar,customization:i},this.requestUpdate()}removeCosmetic(t){const e={...this.editingAvatar.customization};switch(t){case qt.CLOTHES:e.clothes=null;break;case qt.ACCESSORY:e.accessory=null;break;case qt.PET:e.pet=null;break;case qt.THEME:e.theme="default"}this.editingAvatar={...this.editingAvatar,customization:e},this.requestUpdate()}getCosmeticById(t){return t&&this.ownedCosmetics.find(e=>e.id===t)||null}handleSave(){const t=new CustomEvent("avatar-updated",{detail:{childId:this.child.id,avatar:this.editingAvatar},bubbles:!0,composed:!0});this.dispatchEvent(t)}handleReset(){this.editingAvatar=JSON.parse(JSON.stringify(this.child.avatar)),this.requestUpdate()}renderAvatarPreview(){const{customization:t}=this.editingAvatar,e=this.getCosmeticById(t.clothes),i=this.getCosmeticById(t.accessory),s=this.getCosmeticById(t.pet),r=this.getCosmeticById(t.theme);return B`
  ...
  `,t([lt({type:Object})],Kt.prototype,"child",void 0),t([lt({type:Array})],Kt.prototype,"ownedCosmetics",void 0),t([ht()],Kt.prototype,"editingAvatar",void 0),t([ht()],Kt.prototype,"selectedCategory",void 0),customElements.get("hm-avatar-customizer")||customElements.define("hm-avatar-customizer",Kt);let Xt=class extends ot{constructor(){super(...arguments),this._viewMode="overview"}setConfig(t){if(!t)throw new Error("Invalid configuration");if(!t.child_id)throw new Error("child_id is required");this._config=t}getCardSize(){return 4}updated(t){var e;super.updated(t),t.has("hass")&&this.hass&&(this._store||(this._store=(e=this.hass,new It(e)),this._unsubscribe=this._store.subscribe(()=>{this._loadChild(),this.requestUpdate()})),this._loadChild())}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._store&&this._store.destroy()}_loadChild(){this._store&&this._config&&(this._child=this._store.getChild(this._config.child_id))}render(){if(!this._config||!this.hass)return B``;if(!this._child)return B`
        <ha-card>
          <div class="card">
    ...
    `],t([lt({attribute:!1})],Xt.prototype,"hass",void 0),t([ht()],Xt.prototype,"_config",void 0),t([ht()],Xt.prototype,"_store",void 0),t([ht()],Xt.prototype,"_child",void 0),t([ht()],Xt.prototype,"_unsubscribe",void 0),t([ht()],Xt.prototype,"_viewMode",void 0),Xt=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("habits-child-card")],Xt),window.customCards=window.customCards||[],window.customCards.push({type:"habits-child-card",name:"Habits Child",description:"Carte pour enfants pour voir leurs tâches et progresser",preview:!0});export{Xt as HabitsChildCard};
