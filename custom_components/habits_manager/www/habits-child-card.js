...
`;var Dt,Lt,jt,Bt,qt,Ft,Vt,Yt,Wt,Gt,Jt;!function(t){t.MANDATORY="mandatory",t.BONUS="bonus"}(Dt||(Dt={})),function(t){t.DAILY="daily",t.WEEKLY="weekly",t.MONTHLY="monthly",t.SPECIFIC_DATE="specific_date"}(Lt||(Lt={})),function(t){t.CHORES="chores",t.HOMEWORK="homework",t.PERSONAL="personal",t.OTHER="other"}(jt||(jt={})),function(t){t.PENDING="pending",t.COMPLETED_WAITING="completed_waiting",t.VALIDATED="validated",t.REFUSED="refused",t.FAILED="failed"}(Bt||(Bt={})),function(t){t.DAILY="daily",t.WEEKLY="weekly",t.MONTHLY="monthly"}(qt||(qt={})),function(t){t.PROGRESSIVE="progressive",t.FIXED="fixed"}(Ft||(Ft={})),function(t){t.SCREEN_TIME="screen_time",t.MEAL_CHOICE="meal_choice",t.ACTIVITY="activity",t.OTHER="other"}(Vt||(Vt={})),function(t){t.PENDING="pending",t.APPROVED="approved",t.USED="used",t.EXPIRED="expired"}(Yt||(Yt={})),function(t){t.CLOTHES="clothes",t.ACCESSORY="accessory",t.PET="pet",t.THEME="theme",t.BADGE="badge",t.ANIMATION="animation"}(Wt||(Wt={})),function(t){t.COMMON="common",t.RARE="rare",t.EPIC="epic",t.LEGENDARY="legendary"}(Gt||(Gt={})),function(t){t.FIRST_TASK="first_task",t.TASKS_COUNT="tasks_count",t.STREAK_DAYS="streak_days",t.LEVEL_REACHED="level_reached",t.POINTS_EARNED="points_earned"}(Jt||(Jt={}));const Kt={[Gt.COMMON]:"#9E9E9E",[Gt.RARE]:"#2196F3",[Gt.EPIC]:"#9C27B0",[Gt.LEGENDARY]:"#FF9800"};Dt.MANDATORY,Dt.BONUS;class Xt extends ot{constructor(){super(...arguments),this.icon="",this.iconColor="",this.clickable=!1,this.selected=!1}handleClick(){this.clickable&&this.dispatchEvent(new CustomEvent("item-click",{bubbles:!0,composed:!0}))}render(){return B`
      <div
  ...
  `,t([lt({type:String})],Xt.prototype,"icon",void 0),t([lt({type:String})],Xt.prototype,"iconColor",void 0),t([lt({type:Boolean})],Xt.prototype,"clickable",void 0),t([lt({type:Boolean})],Xt.prototype,"selected",void 0),customElements.get("hm-item-card")||customElements.define("hm-item-card",Xt);class Zt extends ot{constructor(){super(...arguments),this.open=!1,this.title="",this.hideActions=!1,this.confirmText="Confirmer",this.cancelText="Annuler",this.hideCancel=!1,this.loading=!1}handleOverlayClick(t){t.target===t.currentTarget&&this.close()}handleCancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0})),this.close()}handleConfirm(){this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0}))}close(){this.open=!1}render(){return this.open?B`
  ...
  `,t([lt({type:Object})],te.prototype,"child",void 0),t([lt({type:Array})],te.prototype,"ownedCosmetics",void 0),t([ht()],te.prototype,"editingAvatar",void 0),t([ht()],te.prototype,"selectedCategory",void 0),customElements.get("hm-avatar-customizer")||customElements.define("hm-avatar-customizer",te);let ee=class extends ot{constructor(){super(...arguments),this._viewMode="overview"}setConfig(t){if(!t)throw new Error("Invalid configuration");if(!t.child_id)throw new Error("child_id is required");this._config=t}getCardSize(){return 4}updated(t){var e;super.updated(t),t.has("hass")&&this.hass&&(this._store||(this._store=(e=this.hass,new Ut(e)),this._unsubscribe=this._store.subscribe(()=>{this._loadChild(),this.requestUpdate()})),this._loadChild())}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._store&&this._store.destroy()}_loadChild(){this._store&&this._config&&(this._child=this._store.getChild(this._config.child_id))}render(){if(!this._config||!this.hass)return B``;if(!this._child)return B`
        <ha-card>
          <div class="card">
    ...
    `],t([lt({attribute:!1})],ee.prototype,"hass",void 0),t([ht()],ee.prototype,"_config",void 0),t([ht()],ee.prototype,"_store",void 0),t([ht()],ee.prototype,"_child",void 0),t([ht()],ee.prototype,"_unsubscribe",void 0),t([ht()],ee.prototype,"_viewMode",void 0),ee=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("habits-child-card")],ee),window.customCards=window.customCards||[],window.customCards.push({type:"habits-child-card",name:"Habits Child",description:"Carte pour enfants pour voir leurs tâches et progresser",preview:!0});export{ee as HabitsChildCard};
