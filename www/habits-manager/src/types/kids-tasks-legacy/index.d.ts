...
export interface Child {
  ...
  // NEW: Added fields for habits-manager migration
  experience: number;
...
// =====================================================
// NEW INTERFACES FOR HABITS-MANAGER MIGRATION
// =====================================================

/**
 * TaskInstance - Represents a specific instance of a task for a child on a date
 * This is a new concept in habits-manager that separates task definitions from task executions
 */
...
/**
 * Habit - Represents a recurring activity that earns streak bonuses
 * This is a new feature in habits-manager distinct from regular tasks
 */
...
/**
 * CosmeticItem - Represents cosmetic items that can be purchased with coins
 * This is a new feature for avatar customization
 */
...
/**
 * RewardClaim - Represents a claim for a real-world reward
 * Enhanced with approval workflow in habits-manager
 */
